...
\addcontentsline{toc}{section}{Rule 1: Rule}

\section*{Rule 2: Rule}\label{rule-2-rule}
\addcontentsline{toc}{section}{Rule 2: Rule}

\section*{Rule 3: Rule}\label{rule-3-rule}
\addcontentsline{toc}{section}{Rule 3: Rule}

\section*{Rule 4: Rule}\label{rule-4-rule}
\addcontentsline{toc}{section}{Rule 4: Rule}

\section*{Rule 5: Rule}\label{rule-5-rule}
\addcontentsline{toc}{section}{Rule 5: Rule}

\section*{Rule 6: Rule}\label{rule-6-rule}
\addcontentsline{toc}{section}{Rule 6: Rule}

\section*{Rule 7: Rule}\label{rule-7-rule}
\addcontentsline{toc}{section}{Rule 7: Rule}

\section*{Rule 8: Rule}\label{rule-8-rule}
\addcontentsline{toc}{section}{Rule 8: Rule}

\section*{Rule 9: Rule}\label{rule-9-rule}
\addcontentsline{toc}{section}{Rule 9: Rule}

\section*{Rule 10: Rule}\label{rule-10-rule}
\addcontentsline{toc}{section}{Rule 10: Rule}
